...
public class AlgoritmoNSGA3 {

	public AlgoritmoNSGA3() {
		super();
	...
	public static int moeaDinamico(SustrateNetwork redFisica, VirtualNetwork redVirtual) {
		...
		nsga.cargarParametros(1, 4, 1, redFisica.getNroNodos(), redVirtual.getNroNodos(), redFisica, redVirtual, 2,
