...
/*
 * Clase con los objetivos 3 y 4
 */
public class AlgoritmoNSGA34 {

	public AlgoritmoNSGA34() {
		super();
	}
	 ...
	 * @return 0 si fue mapeado, 1 caso de falta de cpu, 2 en caso de falta en
	 *         enlaces
	 */
		...
		try {
			...
			for (int i = 0; i < result.size(); i++) {
				...
				if (!solution.violatesConstraints()) {
					...
					objNormalizados[1] = (objectives[1] / redFinal.getCantidadFS());
